...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1002-questions-in-geometric-group-theory-q-6a8dd137",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1002-d02d37c5a41e",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1002"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Belegredek) Is there a 3-complex X (not necessarily aspherical) which is not homotopy equivalent to a 2-complex but H³(X; {G}) = 0 for all local coefficients?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 10.2",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "e48123f34c285ed189d91883048313be0108494f800386c7d9f0ec56dd19fa86"
}
```
